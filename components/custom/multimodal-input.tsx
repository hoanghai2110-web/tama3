...
export function MultimodalInput({
  ...
  <Textarea
    ...
    className="min-h-[24px] h-[110px] w-full resize-none rounded-2xl text-base bg-white dark:bg-[hsl(var(--muted)/.5)] border border-gray-300 dark:border-gray-300 shadow-sm transition-all duration-200 ease-out hover:border-gray-300 dark:hover:border-gray-300 placeholder:text-gray-500 dark:placeholder:text-gray-400 py-4 px-4"
    rows={5}
    onKeyDown={(event) => {
